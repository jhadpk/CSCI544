...
for file in testing_files:
    ...
    positive_truthful_score = get_score(review, positive_truthful_dict, positive_truthful_count, positive_truthful_filecount)
    positive_deceptive_score = get_score(review, positive_deceptive_dict, positive_deceptive_count, positive_deceptive_filecount)
    negative_truthful_score = get_score(review, negative_truthful_dict, negative_truthful_count, negative_truthful_filecount)
    negative_deceptive_score = get_score(review, negative_deceptive_dict, negative_deceptive_count, negative_deceptive_filecount)
